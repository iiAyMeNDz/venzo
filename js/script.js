const commandsData = {
  category1: {
    ...
    commands: [
      {
        name: "/AddtoRoster event",
        description: "To add player to Roster",
        permission: "Manager",
      },
      {
        name: "/RemovefromRoster event",
        description: "To remove someone from roster",
        permission: "Manager",
      },
      {
        name: "/AddtoRoster event",
      ...
      {
        name: "/replaceroster",
        description: "To replace any one in roster",
        permission: "Manager",
      },
      {
        name: "/ClearRoster",
        description: "To everyone in roster",
        permission: "Manager",
      },
    ],
  },
  category2: {
    ...
    commands: [
      {
        name: "/Strike",
        description: "To add strike to player",
        permission: "Manager",
      },
      {
        name: "/Checkstrike",
        description: "Check strike for player",
        permission: "Admin",
      },
      {
        name: "/Clearstrike",
        description: "Clear all strikes from player",
        permission: "Manager",
      },
    ],
  },
  category3: {
    ...
    commands: [
      {
        name: "addbalance",
        description: "To add bonus to the player",
        permission: "Manager",
      },
      {
        name: "/Clearbalance",
        description: "Clear all player balance",
        permission: "Manager",
      },
      {
        name: "/Minusbalance",
        description: "To minus player balance",
        permission: "Manager",
      },
    ],
  },
  category4: {
    ...
    commands: [
      {
        name: "/Remind",
        description: "To remind player about event",
        permission: "Manager",
      },
      {
        name: "/Createvent",
        description: "To creat custom event",
        permission: "Manager",
      },
    ],
  },
